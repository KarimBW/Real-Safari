...
const destinations: MapDestination[] = [
  {
    ...
    name: "Maun Arrival",
    shortName: "Gateway",
    description: "Arrive in Maun and start of package tour",
    poeticDescription: "Where your Botswana adventure begins with warm welcomes and anticipation",
    highlights: ["Meet and greet at airport", "Transfer to hotel", "Free and easy", "Grocery shopping for camping trip"],
    bestFor: "Preparation & arrival",
  ...
  {
    id: "day2",
    name: "Central Kalahari Game Reserve Entry",
    shortName: "CKGR Entry",
    description: "Pickup camper and proceed to Central Kalahari Game Reserve",
    poeticDescription: "Enter the second largest game reserve in the world",
    highlights: ["Pickup camper", "Registration at CKGR gate", "Proceed to 1st campsite", "Setup in pristine wilderness"],
    ...
    movement: {
      departure: "Maun hotel (morning)",
      arrival: "CKGR 1st campsite",
      transport: "4WD camper vehicle",
      travelTime: "Full day travel"
    }
  },
  {
    id: "day3",
    name: "CKGR Second Campsite",
    shortName: "Deep CKGR",
    description: "Proceed to 2nd campsite within CKGR",
    poeticDescription: "Camp here for 2 days to fully enjoy the landscape and wildlife",
    highlights: ["Proceed to 2nd campsite", "Desert-adapted wildlife", "Ancient valleys", "Full CKGR experience"],
    bestFor: "Deep wilderness immersion",
    ...
    movement: {
      departure: "CKGR 1st campsite",
      arrival: "CKGR 2nd campsite",
      transport: "4WD camper",
      travelTime: "Short distance within CKGR"
    }
  },
  {
    id: "day4",
    name: "Makgadikgadi National Park Entry",
    shortName: "Salt Pan Arrival",
    description: "Exit CKGR and proceed to Makgadikgadi National Park",
    poeticDescription: "Enter one of the world's largest salt pans",
    highlights: ["Exit CKGR", "Registration at Makgadikgadi gate", "Proceed to 1st campsite", "Salt pan landscapes"],
    bestFor: "Dramatic landscape change",
    terrain: "Salt pan formations",
    mood: "Otherworldly transition",
    image: "/lovable-uploads/09a00f34-b704-4711-88f5-929dbe49f205.png",
    position: { x: 46, y: 65 },
    day: "Day 4",
    icon: <MapPin className="h-4 w-4" />,
    movement: {
      departure: "CKGR 2nd campsite",
      arrival: "Makgadikgadi 1st campsite",
      transport: "4WD camper transfer",
      travelTime: "Long day travel via park exits"
    }
  },
  {
    id: "day5",
    name: "Makgadikgadi Second Campsite",
    shortName: "Salt Dreams Deep",
    description: "Proceed to 2nd campsite in Makgadikgadi National Park",
    poeticDescription: "Experience the full vastness of ancient salt formations",
    highlights: ["Proceed to 2nd campsite", "Salt pan exploration", "Flamingo spotting", "Endless horizons"],
    ...
    icon: <Camera className="h-4 w-4" />,
    movement: {
      departure: "Makgadikgadi 1st campsite",
      arrival: "Makgadikgadi 2nd campsite",
      transport: "4WD camper",
      travelTime: "Short distance within park"
    }
  },
  {
    id: "day6",
    name: "Nxai Pan National Park Entry",
    shortName: "Zebra Migration Route",
    description: "Exit Makgadikgadi and proceed to Nxai Pan National Park",
    poeticDescription: "Enter an area situated along one of Africa's largest zebra migration routes",
    highlights: ["Exit Makgadikgadi", "Registration at Nxai Pan gate", "Proceed to 1st campsite", "Zebra migration route"],
    bestFor: "Wildlife migration spectacle",
    ...
    icon: <Binoculars className="h-4 w-4" />,
    movement: {
      departure: "Makgadikgadi 2nd campsite",
      arrival: "Nxai Pan 1st campsite",
      transport: "4WD camper transfer",
      travelTime: "Park-to-park transfer"
    }
  },
  {
    id: "day7",
    name: "Nxai Pan Second Campsite & Baines Baobab",
    shortName: "Ancient Giants",
    description: "Proceed to 2nd campsite in Nxai Pan National Park",
    poeticDescription: "Self game drive and exploring the legendary Baines Baobab",
    highlights: ["Proceed to 2nd campsite", "Self game drive", "Exploring Baines Baobab", "Iconic tree photography"],
    bestFor: "Iconic Botswana experience",
    terrain: "Scattered woodlands",
    mood: "Timeless wonder",
    image: "/lovable-uploads/52fba817-468b-49a9-827a-bb36b663d4b6.png",
    position: { x: 72, y: 30 },
    day: "Day 7",
    icon: <Camera className="h-4 w-4" />,
    movement: {
      departure: "Nxai Pan 1st campsite",
      arrival: "Nxai Pan 2nd campsite",
      transport: "4WD camper",
      travelTime: "Short distance within park"
    }
  },
  {
    id: "day8",
    name: "Return to Maun",
    shortName: "Civilization Return",
    description: "Exit Nxai Pan National Park and proceed to Maun",
    poeticDescription: "After handover camper proceed to hotel for final night",
    highlights: ["Exit Nxai Pan", "Handover camper", "Proceed to hotel", "Journey reflection"],
    bestFor: "Transition back to town",
    terrain: "Return journey",
    mood: "Reflective satisfaction",
    image: "/lovable-uploads/262d126c-8864-467a-a4dc-fa9033a12dc2.png",
    position: { x: 80, y: 20 },
    day: "Day 8",
    icon: <MapPin className="h-4 w-4" />,
    movement: {
      departure: "Nxai Pan 2nd campsite",
      arrival: "Maun hotel",
      transport: "4WD camper to town",
      travelTime: "Full day return journey"
    }
  },
  {
    id: "day9",
    ...
    description: "After checkout of hotel, proceed to airport",
    poeticDescription: "End of package tour with memories to last a lifetime",
    highlights: ["Hotel checkout", "Airport transfer", "End of package tour", "Departure preparations"],
    bestFor: "Final farewells",
    terrain: "Airport departure",
    mood: "Grateful completion",
    image: "/lovable-uploads/d02c9222-8e68-4653-b5ca-528385d274b4.png",
    position: { x: 88, y: 15 },
    day: "Day 9",
    icon: <Compass className="h-4 w-4" />,
    movement: {
      departure: "Maun hotel",
      arrival: "Maun Airport",
