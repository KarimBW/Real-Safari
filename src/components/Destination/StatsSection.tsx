...
const StatsSection: React.FC<StatsSectionProps> = ({
  ...
  return <section className="py-16 px-8 md:px-16 flex flex-col md:flex-row">
      <div className="w-full md:w-1/2 pr-0 md:pr-8">
        <h2 className="text-3xl md:text-4xl font-bold mb-8">BUSH INTEL</h2>
      ...
      <div className="w-full md:w-1/2 mt-8 md:mt-0 grid grid-cols-3 gap-4">
        <div className="col-span-2">
          <div className="h-64 bg-gray-200 rounded overflow-hidden">
            ...
            backgroundImage: "url('https://images.unsplash.com/photo-1504432842672-1a79f78e4084?ixlib=rb-4.0.3')"
          }}></div>
          </div>
        </div>
        <div className="col-span-1">
          <div className="h-64 bg-gray-200 rounded overflow-hidden">
            <div className="h-full w-full bg-cover bg-center" style={{
            backgroundImage: "url('https://images.unsplash.com/photo-1517825656053-95ab2b9609e6?ixlib=rb-4.0.3')"
          }}></div>
          </div>
        </div>
      </div>
