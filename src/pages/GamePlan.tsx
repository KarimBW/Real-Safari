...
const GamePlan = () => {
  ...
  const styleOptions: StyleOption[] = [
    ...
    },
    {
      ...
      content: {
        ...
        description:
          "You're the kind of traveler who likes a little dirt under the fingernails, GPS in hand, and freedom in the air. With this option, you take the wheel, plot the course, and set the pace. We handle all the logistics—from vehicle hire to campsite bookings—so you can focus on spotting lions instead of arguing over fuel stops.",
        features: [
  ...
  return (
    <div className="flex flex-col min-h-screen relative">
      ...
      {/* Panel section */}
      {isMobile ? (
        <ChoosePanelMobile styleOptions={styleOptions} scrollToSection={scrollToSection} />
      ) : (
        <div ref={choosePanelRef} className="flex h-screen transition-all duration-500 ease-out">
          ...
          <div className="container mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
              ...
              <div className="camp-info space-y-4 md:space-y-6">
                <h2 className="text-3xl md:text-4xl font-bold text-safari-dark-grey">
                  {styleOptions[0].content.title}
                </h2>
                <h3 className="text-xl md:text-2xl italic text-safari-gold">{styleOptions[0].content.subtitle}</h3>
                <p className="text-safari-dark-grey leading-relaxed">{styleOptions[0].content.description}</p>

                <div className="mt-4 md:mt-6 space-y-3 md:space-y-4">
                  <h3 className="text-lg md:text-xl font-semibold text-safari-dark-grey">
                    You get everything from the self-guided safari, plus:
                  </h3>
                  <ul className="list-disc pl-5 space-y-1 md:space-y-2">
                    {styleOptions[0].content.features.map((feature, index) => (
                      <li key={index} className="text-safari-dark-grey">
                        {feature}
                      </li>
                    ))}
                  </ul>
          ...
          <div className="container mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
              ...
              <div className="camp-info space-y-4 md:space-y-6 order-2 md:order-2">
                <h2 className="text-3xl md:text-4xl font-bold text-safari-dark-grey">
                  {styleOptions[1].content.title}
                </h2>
                <h3 className="text-xl md:text-2xl italic text-safari-gold">{styleOptions[1].content.subtitle}</h3>
                <p className="text-safari-dark-grey leading-relaxed">{styleOptions[1].content.description}</p>
